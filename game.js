...
var enemies = {
    straight: { x: 0, y: -50, sprite: 'enemy_ship', E: 100, health: 10, firePercentage: 0.001 },
...
var Starfield = function(speed, opacity, numStars, clear) {
    ...
    this.draw = function(ctx) {
        ...
        // Draw the top half of the startfield
        if(intOffset > 0) {
            ctx.drawImage(stars,
                          0, remaining,
        ...
        // Draw the Bottom half of the starfiend
        if(remaining > 0) {
            ctx.drawImage(stars,
                          0, 0,
...
PlayerShip.prototype.hit = function(damage, callback) {
    if(this.board.remove(this)) {
        if(this.board.add(new Explosion(this.x + this.w/2, 
                                   this.y + this.h/2))) {
